<div id=header>
    <div class=container-fluid>
        <div class=navbar>
            <div class=navbar-header><a class=navbar-brand href=""><i class="im-tag text-logo-element animated bounceIn"></i><span class=text-logo>T</span><span class=text-slogan>M</span></a></div>
            <nav class=top-nav role=navigation>
                <ul class="nav navbar-nav pull-left">
                    ...
                    <li class=dropdown><a href=# data-toggle=dropdown><i class=ec-mail></i><span class=notification>4</span></a>
                        <ul class="dropdown-menu email" role=menu>
                            ...
                            <li class="mail-list clearfix"><a href=#><img src="{{ asset('assets/img/avatars/128.jpg') }}" class="mail-avatar pull-left" alt=avatar>
                            ...
                            <li class="mail-list clearfix"><a href=#><img src="{{ asset('assets/img/avatars/129.jpg') }}" class="mail-avatar pull-left" alt=avatar>
                            ...
                            <li class="mail-list clearfix"><a href=#><img src="{{ asset('assets/img/avatars/130.jpg') }}" class="mail-avatar pull-left" alt=avatar>
                            ...
                            <li class="mail-list clearfix"><a href=#><img src="{{ asset('assets/img/avatars/131.jpg') }}" class="mail-avatar pull-left" alt=avatar>
                    ...
                    <li class=""><a href="{{ route('registration_ticket') }}"><i class=fa-tags></i></a>
                ...
                <ul class="nav navbar-nav pull-right">
                    ...
                    <li class=dropdown><a href=# data-toggle=dropdown><img class=user-avatar src="{{ asset('assets/img/avatars/default.jpg') }}"> {{ Auth::user()->FullName }}</a>
                        <ul class="dropdown-menu right" role=menu>
                            <li><a href="{{ route('profile') }}"><i class=st-user></i> Perfil</a></li>
                            <li><a href="{{ route('account') }}"><i class=st-cloud></i> Cuenta</a></li>
                            <li><a href="{{ route('settings') }}"><i class=st-settings></i> Configuración</a></li>
                            <li><a href="{{ route('logout') }}"><i class=im-exit></i> Salir</a></li>
                        </ul>
                    </li>
