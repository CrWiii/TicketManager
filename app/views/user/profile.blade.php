    ...
    <div class=content-wrapper>
        <div class=row>
            ...
            <div class="col-lg-12 heading">
                <h4 class=page-header><i class=ec-user></i>Edita tu Perfil</h4>
            </div>
                    ...
                    <div class="panel panel-default plain profile-widget">
                        ...
                        <div class=panel-body>
                            <div class="col-lg-4 col-md-12 col-sm-12">
                                <div class=profile-avatar><img class=img-responsive src=assets/img/avatars/default.jpg alt=@roybarberuk></div>
                            </div>
                            <div class="col-lg-8 col-md-12 col-sm-12">
                                <div class=profile-name>{{ Auth::user()->FullName }} <span class="label label-success">{{ Auth::user()->type }}</span></div>
                                <div class=profile-name><h5>{{ Auth::user()->email }}</h5> </div>
                    ...
                    <div class="panel panel-default plain profile-widget">
                        ...
                        <div class="panel-footer white-bg">
                            <div class="tab-pane fade active in" id=register>
                                {{ Form::model($profile, ['route' => 'update_profile', 'method' => 'PUT', 'role' => 'form', 'class' => 'form-horizontal mt20','novalidate']) }}

                                {{ Field::textarea('description') }}

                                {{ Field::select('Area_Id', $TM_Area) }}

                                {{ Field::select('Group_Id', $TM_Group) }}

                                {{ Field::select('Charge_Id', $TM_Charge) }}
